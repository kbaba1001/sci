...
(def clojure-core
  {:obj clojure-core-ns
   ...
   'derive (copy-var hierarchies/derive* clojure-core-ns)
   'descendants (copy-var hierarchies/descendants* clojure-core-ns)
   ...
   'eval (copy-var eval clojure-core-ns)
   ...
   'letfn (macrofy letfn*)
   'load-string (copy-var load-string clojure-core-ns)
